...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Add knowledge based on cell and count
        cell_column = cell[0]
        cell_row = cell[1]
        ...
        for neighbor in possible_neighbors:
            if (
                neighbor[0] < self.width and 
                neighbor[1] < self.height and 
                neighbor[0] >= 0 and 
                neighbor[1] >= 0 and 
        ...
        for sentence1 in current_knowledge:
            for sentence2 in current_knowledge:

                # Subset
                if sentence2.cells.issubset(sentence1.cells) and len(sentence2.cells) > 0 and sentence2 != sentence1:
